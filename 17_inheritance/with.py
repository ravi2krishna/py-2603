...
class VideoAdmin(Student): # VideoAdmin can inherit watch_videos from Student
    # Add Videos 
    def add_videos(self):
        print("=" * 50)
...
class SuperAdmin(VideoAdmin): # SuperAdmin can inherit watch_videos & add_videos from VideoAdmin
    # Delete Videos 
